...
.\scripts\set_AppConfig_for_tests.ps1 ".\Ocaramba.Tests.NUnit\bin\Release\net8.0" "appsettings.Linux.json" "appSettings" "browser|PathToChromeDriverDirectory|ChromeBrowserExecutableLocation" "Chrome|/opt/hostedtoolcache/setup-chrome/chromedriver/1407831/x64|/opt/hostedtoolcache/setup-chrome/chromium/1407831/x64" -logValues -json
