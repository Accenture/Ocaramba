...
echo '********************************************Features tests********************************************'
dotnet vstest .\Ocaramba.Tests.Features\bin\Release\net8.0\Ocaramba.Tests.Features.dll  /TestCaseFilter:"(TestCategory!=TakingScreenShots)" /Parallel /Logger:"trx;LogFileName=Ocaramba.Tests.Features.xml"

echo '********************************************MsTest tests********************************************'
dotnet vstest .\Ocaramba.Tests.MsTest\bin\Release\net8.0\Ocaramba.Tests.MsTest.dll /TestCaseFilter:"(TestCategory!=TakingScreenShots)" /Parallel /Logger:"trx;LogFileName=Ocaramba.Tests.MsTest.xml"

echo '********************************************Xunit tests********************************************'
dotnet vstest .\Ocaramba.Tests.Xunit\bin\Release\net8.0\Ocaramba.Tests.Xunit.dll  /TestCaseFilter:"(TestCategory!=TakingScreenShots)" /Parallel /Logger:"trx;LogFileName=Ocaramba.Tests.Xunit.xml"

echo '********************************************UnitTests tests********************************************'
...
echo '********************************************EdgeChromium NUnit tests********************************************'

dotnet vstest .\Ocaramba.Tests.NUnit\bin\Release\net8.0\Ocaramba.Tests.NUnit.dll /TestCaseFilter:"(TestCategory=Grid)" /Parallel /Logger:"trx;LogFileName=Ocaramba.Tests.EdgeChromium.xml"
