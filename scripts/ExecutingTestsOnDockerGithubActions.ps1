...
docker exec -u ocaramba ocaramba_selenium bash -c 'pwsh ./scripts/set_AppConfig_for_tests.ps1 "./Ocaramba.Tests.NUnit/bin/Release/net8.0" "appsettings.Linux.json" "appSettings" "browser|PathToChromeDriverDirectory|protocol|host" "Chrome|/usr/local/bin/|http|localhost:7080" -logValues -json'
