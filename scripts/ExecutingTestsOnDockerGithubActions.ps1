...
docker exec -u ocaramba ocaramba_selenium bash -c "ls ./Ocaramba.Tests.NUnit/bin/Debug/net8.0/TestOutput && cp ./Ocaramba.Tests.NUnit/bin/Debug/net8.0/TestOutput /tmp/TestOutput"
