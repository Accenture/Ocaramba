...
docker exec ocaramba_selenium bash -c 'pwsh ./Ocaramba/scripts/set_AppConfig_for_tests.ps1 \"./Ocaramba/Ocaramba.Tests.NUnit/bin/Debug/net8.0\" \"appsettings.Linux.json\" \"appSettings\" \"browser|PathToChromeDriverDirectory\" \"Chrome|/usr/local/bin" -logValues -json'
...
/Ocaramba/Ocaramba/bin/Debug/net8.0/
